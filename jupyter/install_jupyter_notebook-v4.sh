...
VENV_NAME="jupyter_notebook_v4"
PYTHON_VERSION="3.9.12"
NOTEBOOK_VERSION="6.4.12"
JUPYTER_SERVER_VERSION="1.18.1"
JUPYTER_CLIENT_VERSION="7.3.5"
...
# Install specific versions of Jupyter Notebook, jupyter_server, jupyter_client, and jupyter_contrib_nbextensions
echo "Installing Jupyter Notebook (version $NOTEBOOK_VERSION), jupyter_server (version $JUPYTER_SERVER_VERSION), jupyter_client (version $JUPYTER_CLIENT_VERSION), and jupyter_contrib_nbextensions..."
pip install notebook==$NOTEBOOK_VERSION jupyter_server==$JUPYTER_SERVER_VERSION jupyter_client==$JUPYTER_CLIENT_VERSION jupyter_contrib_nbextensions
