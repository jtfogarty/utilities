...
VENV_NAME="jupyter_notebook_v2"
PYTHON_VERSION="3.10.12"
NOTEBOOK_VERSION="6.5.4"
JUPYTER_SERVER_VERSION="1.24.0"
...
# Install specific versions of Jupyter Notebook, jupyter_server, and jupyter_contrib_nbextensions
echo "Installing Jupyter Notebook (version $NOTEBOOK_VERSION), jupyter_server (version $JUPYTER_SERVER_VERSION), and jupyter_contrib_nbextensions..."
pip install notebook==$NOTEBOOK_VERSION jupyter_server==$JUPYTER_SERVER_VERSION jupyter_contrib_nbextensions
